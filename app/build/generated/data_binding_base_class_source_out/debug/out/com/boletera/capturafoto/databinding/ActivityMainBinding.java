...
package com.boletera.capturafoto.databinding;
...
import com.boletera.capturafoto.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnCapture, @NonNull MaterialCardView cardLog,
      @NonNull MaterialCardView cardStatus, @NonNull ScrollView scrollView, @NonNull TextView tvLog,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnCapture, cardLog, cardStatus,
          scrollView, tvLog, tvStatus, tvTitle);
    }
